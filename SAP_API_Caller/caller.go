...
import (
	...
	"sap-api-integrations-purchase-requisition-creates/SAP_API_Caller/responses"
...
func (c *SAPAPICaller) HeaderItem(headerItem *requests.HeaderItem) {
	err := c.callPurchaseRequisitionSrvAPIRequirementHeaderItem("A_PurchaseRequisitionHeader", headerItem)
	if err != nil {
		c.log.Error(err)
		return
	}
