...
import (
	sap_api_caller "sap-api-integrations-purchase-requisition-creates/SAP_API_Caller"
	sap_api_input_reader "sap-api-integrations-purchase-requisition-creates/SAP_API_Input_Reader"
	"sap-api-integrations-purchase-requisition-creates/config"
...
func main() {
	...
	inputSDC := fr.ReadSDC("./Inputs/SDC_Purchase_Requisition_Header_Item_sample.json")
